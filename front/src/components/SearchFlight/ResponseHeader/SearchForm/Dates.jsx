...
export const Dates = React.memo(
  ({ r, departureDate, returnDate, dispatch, oneWay }) => {
    const commonDateProps = {
      r: r,
      type: "date",
      onChange: ({ target }) =>
        dispatch(A.setString({ name: target.name, value: target.value })),
    };
    ...
    const departureDateProps = {
      ...
      value: departureDate,
      onChange: (e) =>
        dispatch(A.setString({ name: "departureDate", value: e.target.value })),
      required: "required",
      ...commonDateProps,
    };
    ...
    const returnDateProps = {
      ...
      value: returnDate,
      onChange: (e) =>
        dispatch(A.setString({ name: "returnDate", value: e.target.value })),
      ...commonDateProps,
    };
