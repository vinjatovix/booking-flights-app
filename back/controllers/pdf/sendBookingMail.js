...
async function sendBookingMail(file, req, next) {
  try {
    ...
    const msg = {
      ...
      DISCLAIMER:
      Aunque los datos de los vuelos son reales, esta aplicación es una simple demostración de conocimientos adquiridos por Mateo Codesido y Pablo Viña.
      Esta reserva no tiene valor real. Ni nos hacemos responsables del uso indebido de la aplicación.
      `,
      html: `
      <H1>Saludos ${req.auth.username}:</H1>
      <p>Te enviamos una copia de la reserva que acabas de hacer. Disfruta del viaje.</p>

      <h1>DISCLAIMER:</h1>
      <p>Aunque los datos de los vuelos son reales, esta aplicación es una simple demostración de conocimientos adquiridos por Mateo Codesido y Pablo Viña .</p>
