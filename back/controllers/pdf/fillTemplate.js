...
const { headerDraw } = require("./headerDraw");
      ...
      <html lang="es">
        ...
        <body>
          ...
          <footer class='footer'>
            ...
            <p> Te hemos enviado este mail a ${header.email} como comprobante de la reserva recientemente realizada. Por favor comprueba los datos y en caso de error no dudes en ponerte en contacto con nosotros via email: flanders.bender@gmail.com. Gracias por confiar en Flight Landers. Disfruta del viaje.</p>
            <br/>
            <hr/>
            <h1>DISCLAIMER:</h1>
