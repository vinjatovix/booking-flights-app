...
-- CHANGE MASTER TO MASTER_LOG_FILE='binlog.000030', MASTER_LOG_POS=156;
...
CREATE TABLE `ReservaDetalles` (
  ...
  `RD_adults` tinyint unsigned NOT NULL,
  PRIMARY KEY (`RD_ID`),
...
-- Dump completed on 2021-01-05 22:36:25
